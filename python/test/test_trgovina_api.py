...
from swagger_client.apis.trgovina_api import TrgovinaApi


class TestTrgovinaApi(unittest.TestCase):
    """ TrgovinaApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.trgovina_api.TrgovinaApi()
