...
from swagger_client.models.moje_stanje import MojeStanje


class TestMojeStanje(unittest.TestCase):
    """ MojeStanje unit test stubs """
    ...
    def testMojeStanje(self):
        """
        Test MojeStanje
        """
        model = swagger_client.models.moje_stanje.MojeStanje()
