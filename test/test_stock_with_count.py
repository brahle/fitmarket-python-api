...
from swagger_client.models.stock_with_count import StockWithCount


class TestStockWithCount(unittest.TestCase):
    """ StockWithCount unit test stubs """
    ...
    def testStockWithCount(self):
        """
        Test StockWithCount
        """
        model = swagger_client.models.stock_with_count.StockWithCount()
